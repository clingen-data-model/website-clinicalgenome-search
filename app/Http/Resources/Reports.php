...
class Reports extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $lock = ($this->status == Title::STATUS_ACTIVE ?
                '<span class="action-lock-report mr-2" data-uuid="' . $this->ident . '" title="Share Report"><i class="fas fa-lock" style="color:lightgray"></i></span>' 
                : '<span class="action-unlock-report mr-2" data-uuid="' . $this->ident . '" title="Share Report"><i class="fas fa-unlock" style="color:red"></i></span>');
