...
$(function () {
  ...
  function set_addr(field, value) {
    ...
    parms.set(field, value); //mostly used by the search results page to preserve terms across reloads

    var a = $('.action-get-type').val();
    if (a !== undefined && a != "") parms.set('type', a);
    var b = $('.action-get-region').val();
    if (b !== undefined && b != "") parms.set('region', b);
...
module.exports = __webpack_require__(/*! /home/saatam/Projects/website-clinicalgenome-search/resources/js/bookmark.js */"./resources/js/bookmark.js");
