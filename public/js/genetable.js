...
function asbadgeFormatter(index, row) {
  ...
  if (row.animal_model_only) return '<a class="btn btn-default btn-block btn-classification" href="/kb/gene-validity/' + row.perm_id + '">' + '' + txt + '<div class="badge badge-warning">' + 'Animal Model Only</div></a>';
