        ...
        <div class="">
          <div class="text-right p-2">
            <ul class="list-inline pb-0 mb-0 small">
                ...
                <li class="text-stats line-tight text-center pl-3 pr-3" data-toggle="tooltip" data-placement="top" title="VCEP refers to the any of the ClinGen Variant Curation Expert Panels. The associated genes are indicated below under the column titled 'Variant Pathogenicity'""><span class="countVariant text-18px"><i class="glyphicon glyphicon-refresh text-18px text-muted"></i></span><br />Genes Included on<br />Approved VCEPs</li>
