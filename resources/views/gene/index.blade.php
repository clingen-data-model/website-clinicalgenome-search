	...
	<div class="row justify-content-center">
      ...
      <table class="mt-3 mb-2">
        <tr>
          ...
          @if ($search == "")
          <td class="text-xl text-gray-600 pl-3 pt-2">Search results for all Genes</td>
          @else
          <td class="text-xl text-gray-600 pl-3 pt-2"><i>Search results for all Genes containing </i><span class="h5 badge badge-secondary matchphrase mb-3">"{{ $search }}"</span></td>
          @endif
        </tr>
      </table>
      </div>
