...
<section id='validity_supporting_data' class="container-fluid">
	<div class="row " id="validity_supporting_data_genetic">
		<hr />
		<div class="col-12 pb-4 rounded shadow" id='tag_genetic_evidence_case_level_with_proband'>
		...
		<div class="col-12 pb-4 rounded shadow" id='tag_genetic_evidence_case_level_without_proband'>
