<table class="table table-compact table-bordered table-border-normal">
    <tbody>
        ...
        <tr>
            ...
            <td>0-3</td>
            <td>12</td>
            <td class="input-width-numbers"><span class="form-group">{{ $record->sop7_variant_is_de_novo_count }}</span>
            </td>
            ...
            <td class="input-width-pmid"><span class="input-width-pmid ">
                    {!!
                    PrintWrapperPmidSop5Gci($record->score_data->GeneticEvidence->CaseLevelData->VariantEvidence->AutosomalDominantOrXlinkedDisorder->VariantIsDeNovo->Evidence
                    ?? null) !!}
                </span></td>
        </tr>
        <tr>
            ...
            <td class="input-width-numbers"><span class="form-group">{{ $record->sop7_proband_with_predicted_count
                    }}</span></td>
            <td class="input-width-numbers points-given-bg">
            ...
            <td class="input-width-pmid ">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->GeneticEvidence->CaseLevelData->VariantEvidence->AutosomalDominantOrXlinkedDisorder->ProbandWithPredictedOrProvenNullVariant->Evidence
                ?? null ) !!}
            </td>
        </tr>
        <tr>
            ...
            <td class="input-width-numbers table-border-thin"><span class="form-group">{{
                    $record->sop7_proband_with_other_count }}</span></td>
            ...
            <td class="input-width-pmid table-border-thin">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->GeneticEvidence->CaseLevelData->VariantEvidence->AutosomalDominantOrXlinkedDisorder->ProbandWithOtherVariantTypeWithSomeEvidenceOfGeneImpact->Evidence
                ?? null ) !!}
        ...
        <tr>
            ...
            <td class="input-width-pmid">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->GeneticEvidence->CaseLevelData->VariantEvidence->AutosomalRecessiveDisease->TwoVariantsInTransAndAtLeastOneDeNovoOrAPredictedProvenNullVariant->Evidence
                ?? null ) !!}
            </td>
        </tr>
        <tr>
            <td class='table-border-thin'>Two variants (not predicted/proven null) with some evidence of gene impact in
                trans</td>
            <td class='table-border-thin'>1</td>
            <td class='table-border-thin'>0-1.5</td>
            <td class=' input-width-numbers table-border-thin'><span class="form-group">{{
                    $record->sop7_two_variants_not_predicted_count }}</span></td>
            <td class=' input-width-numbers  points-given-bg table-border-thin'>
                <div class="form-group">
            ...
            <td class="input-width-pmid  table-border-thin">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->GeneticEvidence->CaseLevelData->VariantEvidence->AutosomalRecessiveDisease->TwoVariantsNotPredictedProvenNullWithSomeEvidenceOfGeneImpactInTrans->Evidence
                ?? null ) !!}

            </td>
        </tr>
        <tr>
            <td colspan="2" rowspan="4" class="table-title table-title-vertical table-heading-line-normal">Segregation
                Evidence</td>
            ...
            <td rowspan="4" class=' input-width-numbers  points-given-bg table-heading-line-normal'>{{
                $record->sop7_segregation_evidence_points_counted }}</td>
            <td rowspan="4" class=" points-tally-bg table-heading-line-normal">{{
                $record->sop7_segregation_evidence_points_counted }}</td>
        ...
        <tr>
            ...
            <td colspan="2" class='table-border-thin'>{{
                $record->score_data->GeneticEvidence->CaseLevelData->SegregationEvidence->ExomeSequencingMethod->SummedLod
                ?? null}}</td>
            <td class=' input-width-numbers table-border-thin'>{{
                $record->score_data->GeneticEvidence->CaseLevelData->SegregationEvidence->ExomeSequencingMethod->FamilyCount
                ?? null}}</td>
            <td class="input-width-pmid  table-border-thin">{!!
                PrintWrapperPmidSop5Gci($record->score_data->GeneticEvidence->CaseLevelData->SegregationEvidence->ExomeSequencingMethod->Evidence
                ?? null) !!}</td>
        </tr>
        <tr>
            <td colspan="2" class='table-heading-line-normal'>Total Summed LOD Score</td>
            <td colspan="2" class='table-heading-line-normal'><span class="form-group">{{
                    $record->score_data->GeneticEvidence->CaseLevelData->SegregationEvidence->TotalPoints ??
                    null}}</span></td>
        ...
        <tr>
            ...
            <td class="input-width-numbers"><span class="form-group">{{
                    $record->score_data->GeneticEvidence->CaseControlData->SingleVariantAnalysis->Count ?? null
                    }}</span></td>
            <td class="input-width-numbers points-given-bg">
                <div class="form-group">
            ...
            <td class="input-width-pmid">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->GeneticEvidence->CaseControlData->SingleVariantAnalysis->Evidence
                ?? null ) !!}
        ...
        <tr>
            ...
            <td colspan="2">0-6</td>
            <td class="input-width-numbers"><span class="form-group">{{
                    $record->score_data->GeneticEvidence->CaseControlData->AggregateVariantAnalysis->Count ?? null
                    }}</span></td>
            <td class="input-width-numbers points-given-bg">
                <div class="form-group">
                    {{ $record->score_data->GeneticEvidence->CaseControlData->AggregateVariantAnalysis->TotalPoints ??
                    null }}
            ...
            <td class="input-width-pmid">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->GeneticEvidence->CaseControlData->AggregateVariantAnalysis->Evidence
                ?? null ) !!}
            </td>
        </tr>
        <tr>
            <td colspan="9" class="table-heading-line-thick table-heading-bg table-heading table-total text-right">Total
                Genetic Evidence Points (Maximum <span id="GeneticEvidenceMax">12</span>)</td>
        ...
        <tr>
            ...
            <td class="input-width-numbers"><span class="form-group">{{
                    $record->score_data->ExperimentalEvidence->Function->BiochemicalFunction->Count ?? null }}</span>
            </td>
            <td class="input-width-numbers points-given-bg">
                <div class="form-group">
            ...
            <td class="input-width-pmid">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->ExperimentalEvidence->Function->BiochemicalFunction->Evidence
                ?? null ) !!}
        ...
        <tr>
            ...
            <td>0 - 2</td>
            <td class="input-width-numbers"><span class="form-group">{{
                    $record->score_data->ExperimentalEvidence->Function->ProteinInteraction->Count ?? null }}</span>
            </td>
            ...
            <td class="input-width-pmid">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->ExperimentalEvidence->Function->ProteinInteraction->Evidence
                ?? null ) !!}
            </td>
        </tr>
        <tr>
            ...
            <td class="input-width-numbers table-border-thin"><span class="form-group">{{
                    $record->score_data->ExperimentalEvidence->Function->Expression->Count ?? null }}</span></td>
            ...
            <td class="input-width-pmid table-border-thin">
                {!! PrintWrapperPmidSop5Gci($record->score_data->ExperimentalEvidence->Function->Expression->Evidence ??
                null ) !!}
            </td>
        </tr>
        <tr>
            ...
            <td class="input-width-numbers"><span class="form-group">{{
                    $record->score_data->ExperimentalEvidence->FunctionalAlteration->PatientCells->Count ?? null
                    }}</span></td>
            <td class="input-width-numbers points-given-bg">
                <div class="form-group">
                    {{ $record->score_data->ExperimentalEvidence->FunctionalAlteration->PatientCells->TotalPoints ??
                    null }}
                </div>
            </td>
            <td rowspan="2" class=" points-tally-bg table-border-thin">
            ...
            <td class="input-width-pmid">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->ExperimentalEvidence->FunctionalAlteration->PatientCells->Evidence
                ?? null ) !!}
            </td>
        </tr>
        <tr>
            ...
            <td class="input-width-numbers table-border-thin"><span class="form-group">{{
                    $record->score_data->ExperimentalEvidence->FunctionalAlteration->NonPatientCells->Count ?? null
                    }}</span></td>
            <td class="input-width-numbers points-given-bg table-border-thin"><span class="form-group">
                    {{ $record->score_data->ExperimentalEvidence->FunctionalAlteration->NonPatientCells->TotalPoints ??
                    null }}
                </span></td>
            <td class="input-width-pmid table-border-thin">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->ExperimentalEvidence->FunctionalAlteration->NonPatientCells->Evidence
                ?? null ) !!}
            </td>
        </tr>
        <tr>
            ...
            <td class="input-width-numbers"><span class="form-group">{{
                    $record->score_data->ExperimentalEvidence->Models->NonHumanModelOrganism->Count ?? null }}</span>
            </td>
            <td class="input-width-numbers points-given-bg"><span class="form-group">
            ...
            <td class="input-width-pmid">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->ExperimentalEvidence->ModelsRescue->NonHumanModelOrganism->Evidence
                ?? null ) !!}
            </td>
        </tr>
        <tr>
            ...
            <td class='table-border-thin'>0 - 2</td>
            <td class="input-width-numbers table-border-thin"><span class="form-group">{{
                    $record->score_data->ExperimentalEvidence->Models->CellCultureModel->Count ?? null }}</span></td>
            <td class="input-width-numbers points-given-bg table-border-thin"><span class="form-group">
                    {{ $record->score_data->ExperimentalEvidence->Models->CellCultureModel->TotalPoints ?? null }}
                </span></td>
            <td class="input-width-pmid  table-border-thin">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->ExperimentalEvidence->Models->CellCultureModel->Evidence ??
                null ) !!}
        ...
        <tr>
            ...
            <td>0 - 4</td>
            <td class="input-width-numbers "><span class="form-group">{{
                    $record->score_data->ExperimentalEvidence->Rescue->RescueInHuman->Count ?? null }}</span></td>
            <td class="input-width-numbers points-given-bg">
                <div class="form-group">
            ...
            <td class="input-width-pmid">
                {!! PrintWrapperPmidSop5Gci($record->score_data->ExperimentalEvidence->Rescue->RescueInHuman->Evidence
                ?? null ) !!}
        ...
        <tr>
            ...
            <td>0 - 4</td>
            <td class="input-width-numbers"><span class="form-group">{{
                    $record->score_data->ExperimentalEvidence->Rescue->RescueInNonHumanModelOrganism->Count ?? null
                    }}</span></td>
            <td class="input-width-numbers points-given-bg">
                <div class="form-group">
                    {{ $record->score_data->ExperimentalEvidence->Rescue->RescueInNonHumanModelOrganism->TotalPoints ??
                    null }}
                </div>
            </td>
            <td class="input-width-pmid">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->ExperimentalEvidence->Rescue->RescueInNonHumanModelOrganism->Evidence
                ?? null ) !!}
            </td>
        </tr>
        <tr>
            ...
            <td>0 - 2</td>
            <td class="input-width-numbers"><span class="form-group">{{
                    $record->score_data->ExperimentalEvidence->Rescue->RescueInCellCultureModel->Count ?? null }}</span>
            </td>
            <td class="input-width-numbers points-given-bg"><span class="form-group">
            ...
            <td class="input-width-pmid">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->ExperimentalEvidence->Rescue->RescueInCellCultureModel->Evidence
                ?? null ) !!}
            </td>
        </tr>
        <tr>
            ...
            <td>0 - 2</td>
            <td class="input-width-numbers"><span class="form-group">{{
                    $record->score_data->ExperimentalEvidence->Rescue->RescueInPatientCell->Count ?? null }}</span></td>
            <td class="input-width-numbers points-given-bg"><span class="form-group">
                    {{ $record->score_data->ExperimentalEvidence->Rescue->RescueInPatientCell->TotalPoints ?? null }}
                </span></td>
            <td class="input-width-pmid">
                {!!
                PrintWrapperPmidSop5Gci($record->score_data->ExperimentalEvidence->Rescue->RescueInPatientCell->Evidence
                ?? null ) !!}
            </td>
        </tr>
        <tr>
            <td colspan="9" class="table-heading-line-thick table-heading-bg table-heading table-total text-right">Total
                Experimental Evidence Points (Maximum <span id="ExperimentalEvidenceMax">6</span>)</td>
            <td class="table-heading-line-thick table-heading-bg table-heading table-total points-tally-bg">
...
<table class="table table-condensed table-bordered table-border-normal">
    <tbody>
        ...
        <tr>
            ...
            <td class="table-heading-line-thick table-text">Case-level, family segregation, or case-control data that
                support the gene-disease association
            </td>
            <td class="table-heading-line-thick table-text">Gene-level experimental evidence that support the
                gene-disease association</td>
            <td class="table-heading-line-thick table-text">Sum of Genetic &amp; Experimental
                <br> Evidence
            </td>
            <td class="table-heading-line-thick table-text">&gt; 2 pubs w/ convincing evidence over time (&gt;3 yrs)
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="2" class="table-heading-line-thick table-heading EvidenceDefinitiveBg">12-18 AND replication
                over time</td>
        </tr>
        <tr>
                    ...
                    <div class="form-group">
                        <table>
                            <tr>
                                ...
                                <td class="col-sm-10">
                                    {!!
                                    PrintWrapperPmidSop5Gci($record->score_data->ValidContradictoryEvidence->Evidence ??
                                    null ) !!}
                                </td>
                            </tr>
                        </table>
        ...
        <tr>
            <td colspan="2" class="table-heading-bg table-heading text-right table-border-thin">CALCULATED
                CLASSIFICATION</td>
            <td colspan="3" class="table-heading-bg table-heading table-border-thin CalculatedClassificationsActive">
                <div class='col-sm-8'>
                    <div>{{ $record->score_data->summary->CalculatedClassification ?? null }}</div>
                </div>
                <div class='col-sm-4'>
        ...
        <tr>
            ...
            <td colspan="3"
                ...
                <div class='col-sm-10'><span style="font-size: 145%;">
                        @if (isset($record->score_data->summary->FinalClassification) &&
                        strtoupper($record->score_data->summary->FinalClassification) == "NO REPORTED EVIDENCE")
        ...
        <tr>
            ...
            <td colspan="3"
                ...
                <div class='col-sm-12 text-left'>
                    @markdown{{ $record->score_data->summary->FinalClassificationNotes ?? null }}@endmarkdown
                </div>
            </td>
        </tr>
        @endif
