...
<table id='validity_classification_matrix' class="table table-compact table-bordered table-border-normal">
  <tbody>
    ...
    <tr>
      <td rowspan="12" class="table-heading-line-thick table-title table-title-vertical">
        <div class="table-title-text">
...
<table class="table table-condensed table-bordered table-border-normal">
  <tbody>
    ...
    <tr>
      ...
      <td colspan="3" class="table-heading-bg table-heading text-left CalculatedClassificationsActive-2 ">
        <div class='col-sm-12'>
    ...
    <tr>
      ...
      <td colspan="3" class="table-heading-bg table-heading table-border-thin CalculatedClassificationsActive-2 ">
        <div class='col-sm-8'>
    ...
    <tr>
      ...
      <td colspan="3" class="table-heading-bg table-heading CalculatedClassificationsActive-3 ">
