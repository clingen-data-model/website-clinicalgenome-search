...
<table class="table table-condensed table-bordered table-border-normal">
      <tbody>
        ...
        <tr>
          ...
          <td colspan="3" class="table-heading-bg table-heading table-border-thin CalculatedClassificationsActive"><div class='col-sm-8'> {{ $record->score_data->summary->CalculatedClassification ?? null }}@if ($record->animalmode)
  ...
  <tr>
    ...
    <td colspan="3" class="table-heading-bg table-heading CalculatedClassificationsActive-3 CalculatedClassificationsActive"><div class='col-sm-12 text-left'>
