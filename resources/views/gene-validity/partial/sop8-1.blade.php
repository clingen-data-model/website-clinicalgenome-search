...
<table class="table table-condensed table-bordered table-border-normal">
  ...
  <tr>
    ...
    <td colspan="3" class="table-heading-bg table-heading CalculatedClassificationsActive-3 CalculatedClassificationsActive"><div class='col-sm-12 text-left'>@markdown {{ $record->score_data->summary->FinalClassificationNotes ?? null }}@endmarkdown</div></td>
  </tr>
      @endif
      @endif
    </table>
