...
<table class="table table-compact table-bordered table-border-normal">
	<tbody>
		...
		<tr>
			...
			<td class="input-width-numbers">12</td>
		...
		<tr>
		  ...
		  <td class="input-width-numbers table-border-thin">{{ $record->sop8_proband_with_other_proband_count }}</td>
		  <td class="input-width-numbers table-border-thin">12</td>
		...
		<tr>
			...
			<td rowspan="2" class=" table-border-thin input-width-numbers">12</td>
		...
		<tr>
		  ...
		  <td class=' input-width-numbers table-border-thin' style="background-color: #f1f1f1">Max</td>
		...
		<tr>
		  ...
		  <td class='table-border-thin'>{{ $record->score_data->GeneticEvidence->CaseLevelData->SegregationEvidence->ExomeSequencingMethod->SummedLod ?? null}}</td>
		...
		<tr>
		  ...
		  <td class='table-heading-line-normal'>{{ $record->score_data->GeneticEvidence->CaseLevelData->SegregationEvidence->TotalPoints ?? null}}</td>
		...
		<tr>
		  ...
		  <td colspan="2" class='table-heading-bg table-heading table-heading-tight'>Count</td>
		  <td class='table-heading-bg table-heading table-heading-tight'>Max</td>
		  <td class='table-heading-bg table-heading table-heading-tight points-given-bg'>Total</td>
		  <td class='table-heading-bg table-heading table-heading-tight points-tally-bg'>Counted</td>
	  </tr>
		<tr>
			...
			<td colspan="2">0-6</td>
			<td colspan="2" id="GeneticEvidence6Max">{{ $record->score_data->GeneticEvidence->CaseControlData->SingleVariantAnalysis->Count ?? null }}</td>
			<td rowspan="2" class="input-width-numbers">12</td>
			<td class="input-width-numbers points-given-bg">
		...
		<tr>
			...
			<td colspan="2">0-6</td>
			<td colspan="2" id="GeneticEvidence6Max">{{ $record->score_data->GeneticEvidence->CaseControlData->AggregateVariantAnalysis->Count ?? null }}</td>
			<td class="input-width-numbers points-given-bg">
				<div class="form-group">
		...
		<tr>
			...
			<td>0.5</td>
			<td>0 - 2</td>
			<td colspan="2" class='' id="ExperimentalEvidence1Max">{{ $record->score_data->ExperimentalEvidence->Function->BiochemicalFunction->Count ?? null }}</td>
			<td rowspan="3" class="input-width-numbers table-border-thin">2</td>
			<td class="input-width-numbers points-given-bg">
				<div class="form-group">
		...
		<tr>
			...
			<td>0.5</td>
			<td>0 - 2</td>
			<td colspan="2" class='' id="ExperimentalEvidence1Max">{{ $record->score_data->ExperimentalEvidence->Function->ProteinInteraction->Count ?? null }}</td>
			<td class="input-width-numbers points-given-bg">
		...
		<tr>
			...
			<td colspan="2" class='table-border-thin' id="ExperimentalEvidence1Max">{{ $record->score_data->ExperimentalEvidence->Function->Expression->Count ?? null }}</td>
			<td class="input-width-numbers points-given-bg table-border-thin">
		...
		<tr>
			...
			<td>1</td>
			<td>0 - 2</td>
			<td colspan="2" class='' id="ExperimentalEvidence2Max">{{ $record->score_data->ExperimentalEvidence->FunctionalAlteration->PatientCells->Count ?? null }}</td>
			<td rowspan="2" class="input-width-numbers table-border-thin">2</td>
			<td class="input-width-numbers points-given-bg">
				<div class="form-group">
		...
		<tr>
			...
			<td class='table-border-thin'>0.5</td>
			<td class='table-border-thin'>0 - 1</td>
			<td colspan="2" class=' table-border-thin' id="ExperimentalEvidence2Max">{{ $record->score_data->ExperimentalEvidence->FunctionalAlteration->NonPatientCells->Count ?? null }}</td>
			<td class="input-width-numbers points-given-bg table-border-thin">
		...
		<tr>
		  ...
		  <td class=''>2</td>
		  <td class=''>0 - 4</td>
		  <td colspan="2" class='' id="">{{ $record->score_data->ExperimentalEvidence->Models->NonHumanModelOrganism->Count ?? null }}</td>
		  <td rowspan="6" class="input-width-numbers ">4</td>
		  <td class="input-width-numbers points-given-bg">
		...
		<tr>
		  ...
		  <td class='table-border-thin'>0 - 2</td>
		  <td colspan="2" class='table-border-thin' id="">{{ $record->score_data->ExperimentalEvidence->Models->CellCultureModel->Count ?? null }}</td>
		  <td class="input-width-numbers points-given-bg table-border-thin">
		...
		<tr>
			...
			<td>2</td>
			<td>0 - 4</td>
			<td colspan="2" class='' id="">{{ $record->score_data->ExperimentalEvidence->Rescue->RescueInHuman->Count ?? null }}</td>
			<td class="input-width-numbers points-given-bg">
		...
		<tr>
			...
			<td>2</td>
			<td>0 - 4</td>
			<td colspan="2" class='' id=""><span class="input-width-numbers">{{ $record->score_data->ExperimentalEvidence->Rescue->RescueInNonHumanModelOrganism->Count ?? null }}</span></td>
			<td class="input-width-numbers points-given-bg">
		...
		<tr>
			...
			<td>1</td>
			<td>0 - 2</td>
			<td colspan="2" class='' id=""><span class="input-width-numbers">{{ $record->score_data->ExperimentalEvidence->Rescue->RescueInCellCultureModel->Count ?? null }}</span></td>
		...
		<tr>
			...
			<td>1</td>
			<td>0 - 2</td>
			<td colspan="2" class='' id=""><span class="input-width-numbers">{{ $record->score_data->ExperimentalEvidence->Rescue->RescueInPatientCell->Count ?? null }}</span></td>
			<td class="input-width-numbers points-given-bg"><span class="form-group">
