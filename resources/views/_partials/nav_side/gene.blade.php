<div class="col-md-2 small">
    <ul class="list-group small text-muted">
      <a href="{{ route('gene-show', $record->hgnc_id) }}" class="list-group-item @if ($navActive == "show") active @endif"><i class="fas fa-file"></i> Gene Summary</a>
      <a href="{{ route('dosage-show', $record->hgnc_id) }}" class="list-group-item @if ($navActive == "dosage") active @endif">Dosage Sensitivity Report
      </a>
