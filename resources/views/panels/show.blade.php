    ...
    <div class="container">
        ...
        <div class="card mb-4">
            ...
            <div class="card-footer d-flex justify-content-between">
                <form action="{{ route('panels.sync', $panel->affiliate_id) }}" method="POST" class="mb-0">
                    @csrf
                ...
                @php
                    $processwireUrl = rtrim(config('processwire.url'), '/');
                @endphp

                <a href="{{ $processwireUrl }}/affiliation/{{ $panel->affiliate_id }}"
