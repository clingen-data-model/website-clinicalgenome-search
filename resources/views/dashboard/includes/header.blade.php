<div class="row mb-1 justify-content-center">
	...
	<!--<div class="col-md-6 pl-0">
        <h1 class="h2"><i class="fas fa-tachometer-alt mr-3"></i>My ClinGen</h1>
    </div>-->
   ...
   <!-- <div class="col-md-3 text-right mt-2 pr-0 hidden-sm  hidden-xs">
        <ul class="list-inline pb-0 mb-0 small">
            <li class="text-stats line-tight text-center pl-3 pr-3"><span class="text-18px action-edit-settings"><i class="fas fa-cog fa-lg pb-1"></i></span><br />Dashboard<br />Settings</li>
            <li class="text-stats line-tight text-center pl-3"><span class="text-18px action-edit-profile"><i class="fas fa-user fa-lg pb-1"></i></span><br />Edit<br />Profile</li>
